...
const FeaturePreview: React.FC<FeaturePreviewProps> = ({ icon, title, description, path, color }) => {
  return (
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Tudo o que você precisa para uma experiência de bronzeamento perfeita
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 max-w-6xl mx-auto">
          <h3 className="text-2xl font-bold mb-6 text-center">Mais Recursos em Breve</h3>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {extraFeatures.map((feature, index) => (
              <div key={index} className="text-center p-4">
                <div className="inline-flex p-3 rounded-full mb-3 bg-amber-100">
                  {feature.icon}
                </div>
