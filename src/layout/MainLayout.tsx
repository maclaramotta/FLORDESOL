...
const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  return <div className="min-h-screen flex flex-col">
      {!isLandingPage && <header className="bg-white border-b border-gray-200 sticky top-0 z-30">
          ...
          {/* Mobile menu */}
          {mobileMenuOpen && <div className="md:hidden bg-white border-t border-gray-100 py-4 px-6">
      ...
      {!isLandingPage && <footer className="bg-gray-50 py-6">
